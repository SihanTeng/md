#!/usr/bin/env bash
# Render the Homebrew cask for TenLing with a released version and DMG SHA-256.
#
# Usage:
#   ./scripts/update-homebrew-cask.sh <version> <dmg-sha256> [cask-file]
#
# cask-file defaults to Casks/tenling.rb in this repo. The Release workflow points
# it at a checkout of the SihanTeng/homebrew-tenling tap repository instead.
...
echo "Updated $CASK_FILE to TenLing $VERSION (sha256: $SHA256)"
